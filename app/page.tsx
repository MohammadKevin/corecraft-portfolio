  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent">
            ...
            <div className="lg:col-span-7 flex flex-col gap-5">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <button
                  type="button"
                  onClick={() => setIsCvModalOpen(true)}
                  className="inline-flex items-center justify-center rounded-full bg-sky-600 text-white px-6 py-3 text-sm font-semibold hover:bg-sky-700 transition-colors shadow-sm cursor-pointer active:scale-95"
                >
      ...
      {isCvModalOpen && (
        ...
        >
          <div className="w-full max-w-lg rounded-3xl bg-white p-6 sm:p-8 shadow-2xl border border-zinc-200/80 relative flex flex-col gap-6 text-left">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-2xl bg-sky-500/10 text-sky-600 flex items-center justify-center border border-sky-400/20">
                  <FileText className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#1C1B1D]">
                    {lang === "id" ? "Unduh Curriculum Vitae" : "Download Resume / CV"}
                  </h3>
                  <p className="text-xs text-[#71717A] mt-0.5">
                    {lang === "id"
                      ? "Pilih versi bahasa yang sesuai dengan kebutuhan Anda."
                      : "Choose the language format that suits your requirements."}
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="flex flex-col gap-3.5">
              ...
              <div className="p-4.5 rounded-2xl border border-zinc-200/90 bg-zinc-50/70 hover:bg-sky-500/[0.04] hover:border-sky-300 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-bold text-[#1C1B1D]">
                      English Version (Resume)
                    </span>
                    <span className="text-[10px] font-mono bg-sky-600 text-white px-2 py-0.5 rounded-full font-semibold">
                      Tech Standard
                    </span>
                  </div>
                  <p className="text-xs text-[#71717A]">
                    {lang === "id"
                      ? "Format internasional standar tech recruiter & remote."
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#1C1B1D] hover:bg-black text-white text-xs font-semibold shadow-xs transition-colors"
                  >
              ...
              <div className="p-4.5 rounded-2xl border border-zinc-200/90 bg-zinc-50/70 hover:bg-emerald-500/[0.04] hover:border-emerald-300 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-bold text-[#1C1B1D]">
                      Bahasa Indonesia (CV Lengkap)
                    </span>
                    <span className="text-[10px] font-mono bg-emerald-600 text-white px-2 py-0.5 rounded-full font-semibold">
                      Standar Magang
                    </span>
                  </div>
                  <p className="text-xs text-[#71717A]">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-semibold shadow-xs transition-colors"
                  >
                    <Download className="w-3.5 h-3.5" />
                    <span>Unduh</span>
                  </a>
            ...
            <div className="pt-3 border-t border-zinc-100 flex items-center justify-between text-xs text-zinc-500">
              ...
              >
                <span>{lang === "id" ? "Lihat / Cetak Format Web Digital →" : "View / Print Web Version →"}</span>
              </Link>
