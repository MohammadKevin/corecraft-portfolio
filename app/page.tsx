              ...
              <div className="p-4 sm:p-4.5 rounded-2xl border border-zinc-200/90 bg-zinc-50/80 hover:bg-emerald-500/[0.04] hover:border-emerald-300 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0 pt-1 sm:pt-0">
                  <a
                    ...
                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-full bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-semibold shadow-xs transition-colors"
                  >
                    <Download className="w-3.5 h-3.5" />
                    <span>Unduh</span>
                  </a>
